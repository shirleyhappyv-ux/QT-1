#############################################################################
# Makefile for building: QT-1
# Generated by qmake (3.1) (Qt 5.15.10)
# Project:  QT-1.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile QT-1.pro
#############################################################################
...
INCPATH       = -I. -I. -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I. -I/usr/include/libdrm -I/usr/lib/qt5/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
COMPRESS      = gzip -9f
DISTNAME      = QT-11.0.0
DISTDIR = /workspaces/QT-1/.tmp/QT-11.0.0
LINK          = g++
LFLAGS        = -Wl,--as-needed,-O1,--sort-common -Wl,-z,pack-relative-relocs -Wl,-O1
LIBS          = $(SUBLIBS) -lgdal /usr/lib/libQt5Widgets.so /usr/lib/libQt5Gui.so /usr/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: QT-1.pro /usr/lib/qt5/mkspecs/linux-g++/qmake.conf /usr/lib/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib/qt5/mkspecs/common/unix.conf \
		/usr/lib/qt5/mkspecs/common/linux.conf \
		/usr/lib/qt5/mkspecs/common/sanitize.conf \
		/usr/lib/qt5/mkspecs/common/gcc-base.conf \
